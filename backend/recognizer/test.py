    ...
    if(train_model == True):
        ...
        def trainDLModel(flag = False) :
            ...
            # Input Parameters
                ...
                model4.compile(loss='categorical_crossentropy',optimizer=(tf.keras.optimizers.legacy.RestoredOptimizer),metrics=['accuracy'])
...
img = cv2.imread('/Users/saurabhgupta/Desktop/DGRCTest/Images/IMG_20230330_164748_783.webp')
